...
#As written, the CONSEL input file will be written just for that subset of families for which a .uml_rec file was produced under each rooted tree. No information is printed about the family/root combinations for which uml_rec output files could not be found.
...
score_num = 0
to_do = [file for file in os.listdir(dirs[0] + "/") if file.endswith("uml_rec")]
for file in to_do:
