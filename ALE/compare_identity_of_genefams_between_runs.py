...
#obtain the list of gene families in common among a set of directories (originally for asking whether differences between ALEml and ALEml_undated results can be attributed to the gene families that get included in the AU analysis)
import os, re, sys
dirs = sys.argv[1:]
trees = {}
summed_lnls = {}
